...
// `/orders/new-v2`. Legacy 4-step OrderForm still owns /orders/new and
// duplicate until the wizard catches up to complex orders.
const OrderWizardV2 = lazy(() => import('./modules/orders-v2/OrderWizardV2'))
const OrderEditV2 = lazy(() => import('./modules/orders-v2/OrderEditV2'))
  ...
  return (
    <Routes>
      ...
      <Route element={<LayoutShell />}>
        ...
        <Route path="/orders/:id/edit-v2" element={<PermissionGate perm="orders" action="edit"><OrderEditV2 /></PermissionGate>} />
